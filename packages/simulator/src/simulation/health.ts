import type { HealthLevel, MeasuredStatus, SystemHealthSummary, SystemState, VesselSnapshot } from '@ave/core-domain/types'
import { worstHealth } from '@ave/core-domain/types'
import { clamp } from '@ave/core-domain/utils/random'
import type { MachineryAnalysis } from '@ave/decision-engine/machineryAnalytics'
